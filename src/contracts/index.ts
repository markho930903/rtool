...
export type TransferHistoryFilterDto = {
  cursor: string | null;
  limit: number | null;
...
export type TransferProgressSnapshotDto = {
  ...
  codec: "bin" | null;
  inflightChunks: number | null;
  retransmitChunks: number | null;
};

export type TransferSendFilesInputDto = {
  peerDeviceId: string;
  pairCode: string;
  files: Array<TransferFileInputDto>;
...
export type TransferUpdateSettingsInputDto = {
  defaultDownloadDir: string | null;
  maxParallelFiles: number | null;
  maxInflightChunks: number | null;
  chunkSizeKb: number | null;
