...
const variantClassMap: Record<ButtonVariant, string> = {
  primary: "border border-transparent bg-accent text-accent-contrast shadow-surface hover:shadow-overlay",
  secondary:
    "border border-border-strong bg-surface-soft text-text-primary shadow-inset-soft hover:border-border-strong hover:bg-surface",
  danger:
    "border border-danger/45 bg-surface-soft text-danger shadow-inset-soft hover:border-danger hover:bg-surface",
  ghost: "bg-transparent text-text-secondary hover:bg-surface-soft hover:text-text-primary",
  outline: "border border-border-muted bg-transparent text-text-secondary hover:border-border-strong hover:bg-surface-soft hover:text-text-primary",
};
...
function buildClassName(props: {
  ...
  return cx(
    ...
    "outline-none focus-visible:ring-2 focus-visible:ring-accent/45 focus-visible:ring-offset-2 focus-visible:ring-offset-app",
