  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className={cx(
          "pointer-events-none absolute inset-0 rounded-full bg-surface-soft shadow-inset-soft",
          "border transition-[background-color,border-color,box-shadow] duration-180 ease-out",
          "peer-focus-visible:ring-2 peer-focus-visible:ring-accent-soft peer-focus-visible:ring-offset-2 peer-focus-visible:ring-offset-app",
          "peer-checked:border-accent peer-checked:bg-accent",
          invalid
            ? "border-danger/80 peer-focus-visible:ring-danger/20 peer-checked:border-danger peer-checked:bg-danger"
      ...
      <span
        aria-hidden="true"
        className={cx(
          "pointer-events-none absolute left-0.5 top-0.5 rounded-full bg-text-secondary",
