...
const variantClassMap: Record<TextareaVariant, string> = {
  ...
  tool: "min-h-[110px] w-full rounded-md border border-border-muted bg-surface px-2.5 py-2 text-[13px] text-text-primary outline-none transition-colors placeholder:text-text-muted focus:border-accent",
};
