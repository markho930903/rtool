...
import ScreenshotSettingsSection from "@/pages/settings/components/ScreenshotSettingsSection";
    ...
    <div className="h-full min-h-0">
      <div className="grid h-full min-h-0 grid-cols-1 md:grid-cols-[220px_1fr]">
        ...
        <div className="min-h-0 overflow-y-auto p-4">
          ...
          {state.nav.activeSection === "screenshot" ? <ScreenshotSettingsSection state={state.screenshot} /> : null}
