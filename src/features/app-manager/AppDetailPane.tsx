  ...
  return (
    <section className="ui-glass-panel flex h-full min-h-0 flex-col px-4 py-4">
      <div className="shrink-0 space-y-3 border-b border-border-glass pb-3">
        ...
        <div
          className="min-h-8 truncate rounded-md border border-border-glass bg-surface-glass-soft px-3 py-2 text-xs text-text-secondary tabular-nums"
          aria-live="polite"
        >
          {cleanupResult
          ...
          <div className="space-y-2">
            ...
            >
              <div className="flex items-start gap-2">
                ...
                />
                <button type="button" className="min-w-0 flex-1 text-left" onClick={() => onRevealPath(mainAppPath)}>
                  <div className="truncate text-sm font-semibold text-text-primary">{selectedApp.name}</div>
                  <div className="truncate text-[11px] text-text-muted">{toBreadcrumb(mainAppPath)}</div>
                </button>
              ...
              <div className="space-y-2" aria-hidden="true">
                {[0, 1, 2, 3, 4].map((index) => (
                  <div
                    ...
                    className="relative overflow-hidden rounded-lg border border-border-glass bg-surface-glass-soft px-3 py-2.5"
                  >
                    <div className="flex items-start gap-2">
                      <span className="mt-0.5 h-5 w-5 shrink-0 rounded-full border border-border-glass bg-surface-glass" />
                      <span className="mt-0.5 h-5 w-5 shrink-0 rounded bg-border-muted/60" />
                      <div className="min-w-0 flex-1">
                        <div className="h-3.5 w-[44%] rounded bg-border-muted/70" />
                        <div className="mt-2 h-2.5 w-[74%] rounded bg-border-muted/55" />
                        <div className="mt-1.5 h-2.5 w-[36%] rounded bg-border-muted/50" />
                      </div>
                      <div className="mt-0.5 h-3.5 w-12 rounded bg-border-muted/65" />
                    </div>
                    <span
