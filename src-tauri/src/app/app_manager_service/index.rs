...
pub(super) fn build_app_index(app: &AppHandle) -> AppResult<Vec<ManagedAppDto>> {
...
pub(super) fn build_self_item(app: &AppHandle) -> Option<ManagedAppDto> {
...
#[cfg(target_os = "macos")]
pub(super) fn collect_macos_apps(app: &AppHandle) -> Vec<ManagedAppDto> {
    let mut items = Vec::new();
...
#[cfg(target_os = "windows")]
pub(super) fn collect_windows_apps(app: &AppHandle) -> Vec<ManagedAppDto> {
