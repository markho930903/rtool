...
fn apply_theme_patch(
    theme: &mut protocol::models::UserThemeSettingsDto,
...
fn apply_glass_theme_patch(
    glass: &mut protocol::models::UserThemeGlassSettingsDto,
...
fn apply_layout_patch(
    layout: &mut protocol::models::UserLayoutSettingsDto,
...
fn apply_locale_patch(
    locale: &mut protocol::models::UserLocaleSettingsDto,
