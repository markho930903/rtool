...
use foundation::i18n::{SYSTEM_LOCALE_PREFERENCE, normalize_locale_preference};
...
fn apply_theme_patch(
    theme: &mut foundation::models::UserThemeSettingsDto,
...
fn apply_glass_theme_patch(
    glass: &mut foundation::models::UserThemeGlassSettingsDto,
...
fn apply_layout_patch(
    layout: &mut foundation::models::UserLayoutSettingsDto,
...
fn apply_locale_patch(
    locale: &mut foundation::models::UserLocaleSettingsDto,
