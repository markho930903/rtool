...
interface ClipboardPanelViewProps {
  ...
  onDownloadPreviewImage: (id: string) => Promise<void>;
}
...
export default function ClipboardPanelView(props: ClipboardPanelViewProps) {
  ...
  return (
    ...
    >
      ...
      {props.error || props.actionFeedback || props.clearAllError ? (
        <div className="mt-2 space-y-2">
          {props.error ? <Message type="error" description={props.error} /> : null}
          {props.actionFeedback ? (
            <Message
              type={props.actionFeedback.kind === "error" ? "error" : "success"}
              description={props.actionFeedback.message}
            />
          ) : null}
          {props.clearAllError ? <Message type="error" description={props.clearAllError} /> : null}
        </div>
      ) : null}
      ...
      <ClipboardImagePreview
        ...
        onDownloadImage={props.onDownloadPreviewImage}
      />
    </section>
  );
}
