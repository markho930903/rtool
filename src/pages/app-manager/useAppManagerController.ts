...
export function useAppManagerController() {
  ...
  const [openPermissionHelpLoadingByAppId, setOpenPermissionHelpLoadingByAppId] = useState<Record<string, boolean>>(
    {},
  );
  ...
  const applyListPage = useCallback(
    (nextItems: ManagedApp[], replace: boolean): ManagedApp[] => {
      ...
      if (replace) {
        ...
        setOpenPermissionHelpLoadingByAppId((prev) => retainById(prev, keep));
  ...
  const selectedOpenPermissionHelpLoading = selectedApp
    ? Boolean(openPermissionHelpLoadingByAppId[selectedApp.id])
    : false;
  ...
  const detail = {
    ...
    openPermissionHelpLoading: selectedOpenPermissionHelpLoading,
  ...
  const actions = {
    ...
    onOpenPermissionHelp: openPermissionHelp,
